...
inputValues.forEach(element => {
    ...
    const firstDigit = parseInt(element.match(/\d/)[0], 10);
    // Find the last digit
    const lastDigit = parseInt(element.match(/\d(?=[^\d]*$)/)[0], 10);

    calibrationValues.push(((firstDigit.toString()) + (lastDigit.toString())));
